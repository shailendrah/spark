...
/**
 * ./bin/run-example ml.OraGBT  [options]
 ...
 * For local mode, run
 * ./bin/spark-submit --class GBT  --driver-memory 1g
...
object OraGBT  {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val parser = new OptionParser[Params]("GBT") {
      head("GBT: an example Gradient-Boosted Trees app.")
      opt[String]("algo")
