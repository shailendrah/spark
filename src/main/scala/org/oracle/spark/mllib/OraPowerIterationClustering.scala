 ...
 *
 * Run with
 * ./bin/run-example mllib.OraPowerIterationClustering [options]
 *
 ...
 *
 * ./bin/run-example mllib.PowerIterationClustering -k 2 --n 10 --maxIterations 15
 *
...
object OraPowerIterationClustering {
  ...
  def main(args: Array[String]): Unit = {
    ...
    val parser = new OptionParser[Params]("PowerIterationClustering") {
      head("PowerIterationClustering: an example PIC app using concentric circles.")
      opt[Int]('k', "k")
